// Pulse Effect - Rhythmic expansion and contraction
function applyPulseEffect(imageData, selectedRegions, danceValue) {
    ...
    selectedRegions.forEach(region => {
        ...
        // Apply pulse effect - scale from center
        const scale = 0.8 + 0.4 * Math.sin(danceValue * Math.PI * 2);
