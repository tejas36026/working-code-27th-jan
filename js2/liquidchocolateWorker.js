...
self.onmessage = function(e) {
  try {
    ...
    console.log('imageData wifht:>> ', imageData.width);
    console.log('imageData wifheightht:>> ', imageData.height);
...
function drawLiquidChocolate(ctx, width, height, progress, deltaTime) {
  ...
  updateLiquidChocolatePhysics(deltaTime, progress);
...
// Update liquid chocolate physics
function updateLiquidChocolatePhysics(deltaTime, progress) {
